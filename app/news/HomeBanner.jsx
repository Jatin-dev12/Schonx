...
const HomeBanner = () => {
  ...
  return (
    <div className="banner-container" ref={containerRef}>
      {/* Static banners */}
      <div className="banner active" style={{ backgroundImage: `url('/images/newsbanners.jpg')` }}>
        <div className='banner-content'>
          <div className='banner-content-left'>
            <h1 className='banner-heading'>Schon’s News</h1>
            <p className='banner-para'>for Indian Homes</p>
              <div className="header-inner-3">
                <a className="header-btn" href="/contact"> Get Free Consultation <img src='/images/arrow.jpg' alt="" /> </a>
              </div>
          </div>
        </div>
      </div>
      <div className="banner" style={{ backgroundImage: `url('/images/newsbanners.jpg')` }}>
        <div className='banner-content'>
          <div className='banner-content-left'>
            <h1 className='banner-heading'>Schon’s News</h1>
            <p className='banner-para'>for Indian Homes</p>
