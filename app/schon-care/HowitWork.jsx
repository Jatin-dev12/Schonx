        ...
        <div className='row row_justify'>
          <div className='col-lg-4 col-md-12'>
            <div className='main-heading'>
              <h2 className='heading'>From Vision to Reality Our End-to-End Process</h2>
              <p className='para'>
                At Schon, we simplify your project lifecycle with an integrated approach. Our in-house team works closely with architects, interior designers, project managers, and homeowners to deliver every detail with care and consistency.
              </p>
            </div>
