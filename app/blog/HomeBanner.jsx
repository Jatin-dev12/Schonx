...
const HomeBanner = () => {
  ...
  return (
    <div className="banner-container" ref={containerRef}>
      {/* Static banners */}
      <div className="banner active" style={{ backgroundImage: `url('/images/blogbg.jpg')` }}>
        <div className='banner-content'>
          <div className='banner-content-left'>
            <h1 className='banner-heading'>Blogs</h1>
            <p className='banner-para'>Insights, Ideas & Innovations from the World of Premium Living.</p>
      ...
      <div className="banner" style={{ backgroundImage: `url('/images/blogbg.jpg')` }}>
        <div className='banner-content'>
          <div className='banner-content-left'>
            <h1 className='banner-heading'>Blogs</h1>
            <p className='banner-para'>Insights, Ideas & Innovations from the World of Premium Living.</p>
