...
const HomeBanner = () => {
  ...
  return (
    <div className="banner-container banner-container-faq" ref={containerRef}>
      {/* Static banners */}
      <div className="banner active" style={{ backgroundImage: `url('/images/faqbanner.jpg')` }}>
        <div className='banner-content'>
          <div className='banner-content-left'>
            <h1 className='banner-heading'>Schon’s FAQs</h1>
            <p className='banner-para'>for Indian Homes</p>
          </div>
        </div>
      </div>
      <div className="banner" style={{ backgroundImage: `url('/images/faqbanner.jpg')` }}>
        <div className='banner-content'>
          <div className='banner-content-left'>
            <h1 className='banner-heading'>Schon’s FAQs</h1>
            <p className='banner-para'>for Indian Homes</p>
